...
namespace LX.Commons
{
    public class HttpHelper
    {
        ...
        public static string PostForForm(string url, Dictionary<string, object> param = null)
        {
            var reqSetting = new HttpRequstSetting
            {
                Url = url,
        ...
        public static T PostForForm<T>(string url, Dictionary<string, object> param = null)
        {
            var res = PostForForm(url, param);
            return JsonConvert.DeserializeObject<T>(res);
        }
