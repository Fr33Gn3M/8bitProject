...
namespace LX.Commons
{
    public class CommonHelper
    {
        ...
        public static void WriteLog(string str, string filename = null)
        {
        ...
        public static object ValueChanged(string type, object value)
        {
            object obj = null;
            ...
            if (string.IsNullOrWhiteSpace(value.ToString()))
                return " ";
            var typeValue = type.ToLower();
            var Value = value.ToString().Trim();
            switch (typeValue)
            {
                case "datetime":
                    obj = Convert.ChangeType(Value, typeof(DateTime));
                    break;
                case "float":
                    obj = Convert.ChangeType(value.ToString().Trim(), typeof(float));
                    break;
                case "varchar(max)":
                case "varchar":
                    obj = Value;
                    break;
                case "bit":
                    obj = Convert.ChangeType(value.ToString().Trim(), typeof(bool));
                    break;
                case "int":
                    obj = Convert.ChangeType(value.ToString().Trim(), typeof(int));
                    break;
            }
            return obj;
        }
        ...
        public static string GetOrderNum()
        {
            ...
            return DateTime.Now.ToString("yyyyMMdd") + timeStamp + randomNumber;
        }
