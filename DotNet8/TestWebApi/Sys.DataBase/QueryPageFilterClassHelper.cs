...
namespace Sys.DataBase
{
    public static class QueryPageFilterClassHelper
    {
        ...
        public static QueryPageFilter NotLike(this QueryPageFilter collection, string FieldName, object value)
        {
            return UpdateQuery(collection, FieldName, SQLSign.NotLike, value);
        }

        public static QueryPageFilter LeftLike(this QueryPageFilter collection, string FieldName, object value)
        {
            return UpdateQuery(collection, FieldName, SQLSign.LeftLike, value);
        }

        public static QueryPageFilter RightLike(this QueryPageFilter collection, string FieldName, object value)
        {
            return UpdateQuery(collection, FieldName, SQLSign.RightLike, value);
        }
        ...
        public static QueryPageFilter GroupByFields(this QueryPageFilter collection, string[] GroupByFieldNames)
        {
            collection.GroupByFieldNames = GroupByFieldNames;
            return collection;
        }
        ...
        public static QueryPageFilter LogSqlString(this QueryPageFilter collection, string logKey)
        {
            collection.IsLog = true;
            collection.LogKey = logKey;
            return collection;
        }
        //private static QueryPageFilter UpdateQuery(QueryPageFilter collection, string FieldName, SQLSign sign, object value)
        //{
