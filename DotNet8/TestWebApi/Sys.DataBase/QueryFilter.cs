...
using Sys.DataBase.JsonConverters;
...
namespace Sys.DataBase
{
    ...
    public class SpatialQueryFilter : QueryFilterBase
    {
        ...
        public THGeometry Geometry { get; set; }
        [JsonProperty("FieldName")]
        public string FieldName { get; set; }
        [JsonProperty("Sign")]
        [JsonConverter(typeof(StringEnumConverter))]
    ...
    public class QueryPageFilter
    {
        ...
        {
            IsPage = false;
            IsReturnCount = false;//是否只还回count
            IsDelete = false;
            IsConvertPart = false;
            IsGetCount = true;//是否得到count
        }
        ...
        internal static bool IsSqlFilter2(object obj)
        {
            if (obj == null)
                return false;
            var InText = obj.ToString();
            string word = "and|exec|insert|select|delete|update|*|%|chr|mid|master|truncate|char|declare|join|;|or|-|+|,";
            //string word = "and|exec|insert|select|delete|update|count|*|%|chr|mid|master|truncate|char|declare|join|;|or|-|+|,";
            if (InText == null)
                return false;
